...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // PlayerControllerSO a reference to the text object's textInfo
            ...
            // PlayerControllerSO the handle size for drawing the various
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // PlayerControllerSO Bottom Left and Top Right position of the current character
        ...
        void DrawBounds()
        {
            ...
            // PlayerControllerSO Bottom Left and Top Right position of each word
